---
title: St. Columba Parish, Oakland
created: 2026-05-13
updated: 2026-05-14
type: entity
...
![Visual dossier card for St. Columba Parish, Oakland](east-bay-catholic-property-monitor/assets/visuals/site-card-saint-columba-oakland.svg)
...
- Address/source address: 6401 San Pablo Avenue, Oakland
...
- Core parcel lot area: 42,800 sq ft
- Core parcel API component total (`SHP_LANDVALUE + SHP_IMPRVMTS_VALUE`): $1.9M
- Core parcel API assessed-value total: $0
- Same-ZIP sampled median land value: $32.55/sq ft (weighted across core parcels; sample n≈9910).
- Core acquisition/redevelopment screen: $766,227–$1.7M (mid $1.2M).
- Expanded adjacent-campus envelope screen: $1.5M–$3.4M (mid $2.3M).
...
- APN `16-1455-7` — 6401 SAN PABLO AVE OAKLAND 94608; owner: ROMAN CATHOLIC WELFARE CORPORATION OF OAKLAND; lot: 20,000 sq ft; building area: 5,976 sq ft; use: `6600`; component total: $914,378; assessed: $0.
- APN `16-1455-8` — 6401 SAN PABLO AVE OAKLAND 94608; owner: ROMAN CATHOLIC BISHOP OF OAKLAND; lot: 22,800 sq ft; building area: unknown; use: `6600`; component total: $940,506; assessed: $0.

## Adjacent / campus parcels to verify

- APN `16-1450-11-1` — 1086 ALCATRAZ AVE OAKLAND 94608; owner: ROMAN CATHOLIC WELFARE CORPORATION OF OAKLAND; lot: 24,000 sq ft; use: `6400`; component total: $456,101.
- APN `16-1451-8-1` — 1094 ALCATRAZ AVE OAKLAND 94608; owner: ROMAN CATHOLIC WELFARE CORPORATION; lot: 16,000 sq ft; use: `7500`; component total: $4.7M.
