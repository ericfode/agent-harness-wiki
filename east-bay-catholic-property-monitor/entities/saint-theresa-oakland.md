---
title: St. Theresa Parish, Oakland
created: 2026-05-13
updated: 2026-05-14
type: entity
...
![Visual dossier card for St. Theresa Parish, Oakland](east-bay-catholic-property-monitor/assets/visuals/site-card-saint-theresa-oakland.svg)
...
- Address/source address: 30 Mandalay Road, Oakland
...
- Notes: Official Oakland parish-directory entry. Not on closure list as of baseline; nearby Catholic welfare parcels may be school/campus-related.
...
- Core parcel lot area: 43,765 sq ft
- Core parcel API component total (`SHP_LANDVALUE + SHP_IMPRVMTS_VALUE`): $1.5M
- Core parcel API assessed-value total: $0
- Same-ZIP sampled median land value: $56.01/sq ft (weighted across core parcels; sample n≈10566).
- Core acquisition/redevelopment screen: $1.3M–$3.1M (mid $2.1M).
- Expanded adjacent-campus envelope screen: $6.4M–$14.6M (mid $9.9M).
...
- APN `48B-7153-23-2` — 30 MANDALAY RD OAKLAND 94618; owner: ROMAN CATHOLIC WELFARE CORPORATION OF OAKLAND; lot: 41,420 sq ft; building area: unknown; use: `6600`; component total: $1.2M; assessed: $0.
- APN `48B-7153-23-1` — 33 MANDALAY RD OAKLAND 94618; owner: ROMAN CATHOLIC WELFARE CORPORATION OF OAKLAND; lot: 2,345 sq ft; building area: 5,469 sq ft; use: `1100`; component total: $310,641; assessed: $0.

## Adjacent / campus parcels to verify

- APN `48B-7153-15` — 4734 CLAREWOOD DR OAKLAND 94618; owner: ROMAN CATHOLIC WELFARE CORPORATION OF OAKLAND; lot: 44,674 sq ft; use: `3300`; component total: $138,770.
- APN `48B-7152-8-2` — 4850 CLAREWOOD DR OAKLAND 94618; owner: ROMAN CATHOLIC WELFARE CORPORATION OF OAKLAND; lot: 111,034 sq ft; use: `6400`; component total: $4.1M.
- APN `48B-7153-34` — CLAREWOOD DR OAKLAND 94603; owner: ROMAN CATHOLIC WELFARE CORPORATION OF OAKLAND; lot: 30,304 sq ft; use: `1000`; component total: $112,781.
