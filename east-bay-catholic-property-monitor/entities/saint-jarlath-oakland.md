---
title: St. Jarlath Parish, Oakland
created: 2026-05-13
updated: 2026-05-14
type: entity
...
# St. Jarlath Parish, Oakland

<!-- oakland-visuals:start -->
## Visuals

![Visual dossier card for St. Jarlath Parish, Oakland](east-bay-catholic-property-monitor/assets/visuals/site-card-saint-jarlath-oakland.svg)
...
- Address/source address: 2620 Pleasant Street, Oakland
...
- Core parcel lot area: 30,751 sq ft
- Core parcel API component total (`SHP_LANDVALUE + SHP_IMPRVMTS_VALUE`): $3M
- Core parcel API assessed-value total: $0
- Same-ZIP sampled median land value: $34.12/sq ft (weighted across core parcels; sample n≈8596).
- Core acquisition/redevelopment screen: $577,013–$1.3M (mid $891,747).
...
- APN `28-904-23-2` — 2620 PLEASANT ST OAKLAND 94602; owner: ROMAN CATHOLIC BISHOP OF OAKLAND; lot: 30,751 sq ft; building area: unknown; use: `6600`; component total: $3M; assessed: $0.

## Adjacent / campus parcels to verify

- APN `28-904-23-3` — 2634 PLEASANT ST OAKLAND 94602; owner: ROMAN CATHOLIC WELFARE CORPORATION OF OAKLAND; lot: 48,936 sq ft; use: `6400`; component total: $991,013.
